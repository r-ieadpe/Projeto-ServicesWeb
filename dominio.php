            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <?php
                            $arrayList = getArray(0);
                        ?>
                        <div class="panel-heading">
                            <h3 class="panel-title">Domínios</h3></div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <?php foreach ($arrayList as $dom) {?>
                                    <a href="<?php echo "modelo.php?id=".$dom["@Ontology#id"];?>"><li class="list-group-item"><?php echo $dom["@Ontology#id"]." - ".$dom["@Ontology#label"]."<br>";?></li></a>
                                <?php }?>
                            </ul>
                        </div>
                    </div>
